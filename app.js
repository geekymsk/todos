...
app.use (
  sassMiddleware({
    src: __dirname + '/sass', // Source directory used to find .scss or .sass files.
    dest: __dirname + '/public', // ) Destination directory used to output .css files (when undefined defaults to src)
    debug: true,
  })
);
